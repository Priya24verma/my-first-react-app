...
<div className="mb-3">
  ...
  <button type="button" className="btn btn-primary mx-2" onClick={handleClearClick}>Clear the text </button>
  {/* <button type="button" className="btn btn-primary mx-2" onClick={handleTitleClick}>Title the text </button> */}
    <button type="button" className="btn btn-primary mx-2" onClick={handleCopy}>Copy the text </button>
    <button type="button" className="btn btn-primary mx-2" onClick={handleExtraSpaces}>Remove the extra space </button>
    ...
    <div className="container my-3" style={{color: props.mode==='dark'?'white':'#042743'}}>
        ...
        <h2>Preview</h2>
        <p>{text.length>0?text:"enter the something above to preview here"}</p>
    </div>
    </>
  )
} 
